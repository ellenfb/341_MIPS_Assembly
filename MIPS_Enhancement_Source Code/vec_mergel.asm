...
#
# Description: 		Code implementing the instruction 'vec_mergel d, a, b' into MIPS architecture. D, A, and B are 8-byte vectors with 2-byte wide elements. The upper and lower halves of each vector are split between two registers. The instruction places the second halves of vectors A and B into vector D alternating. A4 => D0, B4 = > D1, A5 => D2 and so on.
#
